...
local LogMessage = require 'scripts.ErnOneStick.vendor.H3.scripts.s3.logmessage'
...
local function new(constructorData)
    ...
    ---@type ShadowTableSubscriptionHandler
    local handler = constructorData.subscribeHandler ~= nil and constructorData.subscribeHandler or
...
local ProtectedTableInterface = {
    interfaceName = 'ErnOneStick_S3ProtectedTable',
