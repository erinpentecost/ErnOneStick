...
local common = require("scripts.ErnOneStick.common")
local infrequent = require("scripts.ErnOneStick.infrequent")
local cells = require("scripts.ErnOneStick.cells")
local note = require("scripts.ErnOneStick.note")
local macguffins = require("scripts.ErnOneStick.macguffins")
local containerUtil = require("scripts.ErnOneStick.containerUtil")
...
local function setBonus(player, amount)
    ...
    world.mwscript.getGlobalVariables(player)["ErnOneStick_questbonus"] = math.ceil(amount)
end
